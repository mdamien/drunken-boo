...
console.log("Begin DeviceOrientationControls")
/*document.documentElement.mozRequestFullScreen();
alert(screen.mozLockOrientation('portrait'));
*/  this.object = object;
  ...
  window.screen.addEventListener('orientationchange', onScreenOrientationChangeEvent, false);
  ...
  this.update = (function(delta) {
    ...
    return function(delta) {
      ...
      // needed for old firefox browser
      var orientation = getOrientation();
      if (orientation !== this.screenOrientation) {
        this.screenOrientation = orientation;
        //peut etre garder le autoLign
        this.autoAlign = true;
        console.log("change "+this.screenOrientation)
      }
